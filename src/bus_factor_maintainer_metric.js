...
function bus_factor_maintainer_metric(repoURL) {
    return __awaiter(this, void 0, void 0, function () {
        var bus_factor, responsive_maintainer, url, sections, topContributorsURL, response, contributors, error_1, contributorsURL, response, header, matchResult, lastPage, error_2, query, gqlRequest, error_3;
